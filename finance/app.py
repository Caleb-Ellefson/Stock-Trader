...
def buy():
    ...
    if request.method == "GET":
        ...
        updt_cash = usd(user_cash - total_price)
        ...
        db.execute("INSERT INTO purchases (symbol, shares, price, date, user_id, type) VALUES (?, ?, ?, ?, ?, 'BUY')", stock["symbol"], quantity, usd(stock["price"]), date, user_id)
